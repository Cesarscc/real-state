...
export function Properties() {
    ...
    const [counterHouse, setCounterHouses] = useState(8);
    const dataFilteredHouses = dataProperties.slice(0, counterHouse);

    const loadMoreHouse = () => {
        setCounterHouses(counterHouse + 4);
    }
    ...
    return (
        <Transition className="px-4 py-8 md:py-32 md:px-40">
            ...
            <div className="text-center my-7">
                {counterHouse < dataProperties.length && (<button className="p-6 text-white transition-all duration-150 cursor-pointer bg-secondary rounded-xl hover:bg-black" onClick={loadMoreHouse}>Ver más viviendas</button>)}
